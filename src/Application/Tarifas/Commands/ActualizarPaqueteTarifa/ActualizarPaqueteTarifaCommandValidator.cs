...
public sealed class ActualizarPaqueteTarifaCommandValidator : AbstractValidator<ActualizarPaqueteTarifaCommand>
{
    public ActualizarPaqueteTarifaCommandValidator()
    {
